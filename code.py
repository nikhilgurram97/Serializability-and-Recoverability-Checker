...
# Generates conflict pairs for the generated history
class ConflictGen():
...
print "\n"
print "\n"
#generates all possible permutations of generated transactions
...
obj1.permgen()
#compare this history to the generated conflict pairs of permutations and check serializability
class HisCompare():
...
if temp2==0:
    print"The conflict pairs of generated schedule are not in serial order with any of the serial executions, so schedule is NOT-SERIALIZABLE"

if temp2==1:
    print "generated schedule is SERIALIZABLE"
# checks the recoverability of the generated history and says whether its RC ACA or ST
class Recover():
